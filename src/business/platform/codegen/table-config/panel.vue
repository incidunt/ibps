...
<script>
import { queryPageList } from '@/api/platform/codegen/tableConfig'
    ...
    return {
      ...
      listConfig: {
        ...
        searchForm: {
          labelWidth: 100,
          forms: [
            { prop: 'Q^table_name_^SL', label: '表名：', itemWidth: 200 },
            { prop: 'Q^table_comment_^SL', label: '表注释', itemWidth: 200 }
          ]
        },
        // 表格字段配置
        columns: [
