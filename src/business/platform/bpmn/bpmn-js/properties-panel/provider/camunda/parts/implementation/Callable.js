...
module.exports = function(element, bpmnFactory, options, translate) {
  ...
  const html = '<label for="camunda-callable-element-ref">' + translate('Called Element') +
  '<a class="ibps-icon-sub-process" id="selectSubProcess" href="javascript:void(0)">&nbsp;&nbsp;' + translate('Select') + '</a>' +
'</label>' +
'<div class="bpp-field-wrapper"> ' +
  '<input id="camunda-callable-element-ref" type="text" name="callableElementRef"  />' +
'</div>'
